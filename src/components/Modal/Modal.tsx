...
import { ModalBody, ModalContainer, ModalContent, ModalHeader, ModalImage, ModalButtonClose } from './styles';
...
const Modal = () => {
  return (
    <ModalContainer>
      <ModalContent>
          <ModalButtonClose><BsXLg /></ModalButtonClose>
          <ModalHeader>
            <ModalImage src='https://image.tmdb.org/t/p/w500/8L4mdjd9Zuxju3cDB3spgJ8AOPw.jpg' />
